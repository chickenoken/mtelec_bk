  ...
  return (
    <>
      ...
      <Grid container spacing={10}>
        ...
        <Grid md={6}>
          <Box className="w-40 mb-4" >
            <input type="file" {...register('image8')} ref={fileImg8} style={{ display: 'none' }} onChange={(e) => handleFileChange(e, setImageSrc8, 'image8')} />
            <Button variant="contained" color="primary" className='bg-mte mb-2' onClick={() => handleUploadClick(fileImg8)}>
              Upload
            </Button>
            { imageSrc8 && 
          ...
          <TextField error={Boolean(errors.name8)} InputLabelProps={{ shrink: !!watch('name8') }} required fullWidth variant="outlined" size="small" label="Name" autoFocus {...register('name8')}/>
          {/* @ts-ignore */}
        ...
        <Grid md={6}>
          <Box className="w-40 mb-4" >
            <input type="file" {...register('image9')} ref={fileImg9} style={{ display: 'none' }} onChange={(e) => handleFileChange(e, setImageSrc9, 'image9')} />
            <Button variant="contained" color="primary" className='bg-mte mb-2' onClick={() => handleUploadClick(fileImg9)}>
              Upload
            </Button>
            { imageSrc9 && 
          ...
          <TextField error={Boolean(errors.name9)} InputLabelProps={{ shrink: !!watch('name9') }} required fullWidth variant="outlined" size="small" label="Name" autoFocus {...register('name9')}/>
          {/* @ts-ignore */}
        ...
        <Grid md={6}>
          <Box className="w-40 mb-4" >
            <input type="file" {...register('image10')} ref={fileImg10} style={{ display: 'none' }} onChange={(e) => handleFileChange(e, setImageSrc10, 'image10')} />
            <Button variant="contained" color="primary" className='bg-mte mb-2' onClick={() => handleUploadClick(fileImg10)}>
              Upload
            </Button>
            { imageSrc10 && 
          ...
          <TextField error={Boolean(errors.name10)} InputLabelProps={{ shrink: !!watch('name10') }} required fullWidth variant="outlined" size="small" label="Name" autoFocus {...register('name10')}/>
          {/* @ts-ignore */}
        ...
        <Grid md={6}>
          <Box className="w-40 mb-4" >
            <input type="file" {...register('image11')} ref={fileImg11} style={{ display: 'none' }} onChange={(e) => handleFileChange(e, setImageSrc11, 'image11')} />
            <Button variant="contained" color="primary" className='bg-mte mb-2' onClick={() => handleUploadClick(fileImg11)}>
              Upload
            </Button>
            { imageSrc11 && 
          ...
          <TextField error={Boolean(errors.name11)} InputLabelProps={{ shrink: !!watch('name11') }} required fullWidth variant="outlined" size="small" label="Name" autoFocus {...register('name11')}/>
          {/* @ts-ignore */}
