...
import { getPHvac, savePHvac } from "../_server/FormHvacAction";
...
const FormHvac = () => {
	...
	return (
		<>
			...
			{dataWithoutImg && (
				<TableWorkingFields data={dataWithoutImg} workingFieldUrl="/user/pages/hvac/workingField" />
			)}
