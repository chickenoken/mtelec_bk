...
import {
	createWorkingField,
	getPSolarDataById,
	getPSolarWorkingFieldById,
	updateWorkingFieldByWorkingId,
} from "../../server/FormSolarAction";
			...
			<Grid item xs={12} md={4} lg={3}>
				<Paper sx={{ p: 2, display: "flex", flexDirection: "column" }}>
					<Suspense>
						<FormWorkingField
							id={id}
							backUrl="/user/pages/solar"
							getDataOfThis={getPSolarDataById}
							getWorkingFieldById={getPSolarWorkingFieldById}
