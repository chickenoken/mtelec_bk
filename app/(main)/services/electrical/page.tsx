    ...
    <>
      ...
      <Container className="my-4">
          ...
          <Grid container spacing={5}>
            <Grid md={6}>
              <Box className="flex items-start justify-start mb-2">
                ...
                <Typography className='text-sm font-bold'>The purpose of this program are:</Typography>
              </Box>
            ...
            <Grid md={6}>
              <Box className="flex justify-start mb-2">
                ...
                <Typography className='text-sm font-bold'>Worked and Reported by MTELEC</Typography>
              </Box>
              <Box className="flex items-center justify-start mb-2 ps-6">
                <LuDot />
              ...
              <Box className="flex items-center justify-start mb-2 ps-6">
                <LuDot />
                <Typography className='text-sm'>Upload Data on Easypower Sofware</Typography>
              </Box>
              <Box className="flex items-center justify-start mb-2 ps-6">
                <LuDot />
        ...
        <Box className="mt-10 p-8">
          <Grid container>
            <Grid md={6}>
              <Image className='me-2' src="/asset/img/service/electrical/img_1.png" alt="alt" width={700} height={700} />
            </Grid>
            <Grid md={6}>
              <Box className="flex items-center justify-center mb-4">
                <Card className="shadow-lg" sx={{ width: 190, height: 150 }}>
                  <CardContent className="p-2">
                    <Image className='' src="/asset/img/service/electrical/img_2.png" alt="alt" width={170} height={170} />
                  </CardContent>
                </Card>
                <Card className="shadow-lg mx-auto" sx={{ width: 190, height: 150 }}>
                  <CardContent className="p-2">
                    <Image className='' src="/asset/img/service/electrical/img_3.png" alt="alt" width={170} height={170} />
                  </CardContent>
                </Card>
              </Box>
              <Box className="flex items-center justify-center">
                <Card className="shadow-lg" sx={{ width: 300, height: 250 }}>
                  <CardContent className="p-2">
                    <Image className='' src="/asset/img/service/electrical/img_4.png" alt="alt" width={300} height={200} />
                  </CardContent>
                </Card>
              </Box>
            </Grid>
        ...
        <Box className="mt-10 p-8" sx={{ backgroundImage: `url('/asset/img/about/bg_1.png')`, backgroundSize: 'cover'}}>
          ...
          <Box className="flex items-start justify-start mb-2">
            ...
            <Typography className='text-sm'>&nbsp;Contactor, CBs , Connection , Relays.</Typography>
          </Box>
          <Box className="flex items-start justify-start mb-2">
            <Image className='me-2 my-[2px]' src="/asset/svg/icon.svg" alt="alt" width={15} height={15} />
            <Typography className='text-sm font-bold'>Measuring Device :</Typography>
            <Typography className='text-sm'>&nbsp;Fluke TiS75+ Infrared Thermal Imaging Camera (Origin: USA)</Typography>
          </Box>
          <Box className="flex items-start justify-start mb-2">
            <Image className='me-2 my-[2px]' src="/asset/svg/icon.svg" alt="alt" width={15} height={15} />
          ...
          <Grid container>
            <Grid md={5}>
              <Box display="flex" alignItems="center" justifyContent="center" sx={{height: '100%'}}>
                <Image className='me-2' src="/asset/img/service/electrical/img_5.png" alt="alt" width={340} height={340} />
              </Box>
            </Grid>
            <Grid md={7}>
              <Box display="flex" alignItems="center" justifyContent="center" sx={{height: '100%'}}>
                <Image className='me-2' src="/asset/img/service/electrical/img_7.png" alt="alt" width={900} height={900} />
              </Box>
            </Grid>
          </Grid>
        </Box>
        ...
        <AnimUp>
        <Box className="mt-10 p-8" sx={{ backgroundImage: `url('/asset/img/about/bg_1.png')`, backgroundSize: 'cover'}}>
          <Typography variant="h5" className="font-bold trilong italic mb-4">Electrical Supervisor and Consultancy for Local and Oversea</Typography>
        </Box>
        <Box>
          <Image className='me-2 w-full h-full' src="/asset/img/service/electrical/img_6.png" alt="alt" quality={100} width={1920} height={1800} /> 
        </Box>
        <Box className="mt-10 p-8" sx={{ backgroundImage: `url('/asset/img/about/bg_1.png')`, backgroundSize: 'cover'}}>
