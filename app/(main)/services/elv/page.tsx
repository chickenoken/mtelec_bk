          ...
          <Grid container spacing={5}>
            <Grid md={6}>
              <Box className="flex justify-start mb-2">
                ...
                <Typography className='text-sm font-bold'>Data System</Typography>
              </Box>
              <Box className="flex justify-start mb-2">
                <Image className='me-2' src="/asset/svg/icon.svg" alt="alt" width={15} height={15} />
                <Typography className='text-sm font-bold'>Public Address and Telephone System</Typography>
              </Box>
            </Grid>
            <Grid md={6}>
              <Box className="flex justify-start mb-2">
              ...
              <Box className="flex justify-start mb-2">
                <Image className='me-2' src="/asset/svg/icon.svg" alt="alt" width={15} height={15} />
                <Typography className='text-sm font-bold'>CCTV System</Typography>
              </Box>
            </Grid>
          </Grid>
        </Box>
