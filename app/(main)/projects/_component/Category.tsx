	...
	return (
		<div
			...
			style={{
				...
				borderRadius: "500px",
				background:
					"var(--Green-Gradient, linear-gradient(266deg, #00B6D7 -6.05%, #4ABEA6 26.45%, #33AF4A 80.61%))",
				width: "45px",
				height: "45px",
				zIndex: 1,
			}}
...
const Category = () => {
	...
	return (
		<>
				...
				<Slider {...settings}>
					<Card className=" h-50" sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
						...
						>
							...
							>
								<Typography variant="h6" className="text-center font-bold my-2">
									ALL CATEGORIES
								</Typography>
								<Image
									className="my-2"
									src="/asset/img/projects/catotegry_all.png"
									alt="catotegry_all.png"
									width={100}
									height={100}
								/>
								<Typography variant="body2" className="text-center txt-mte my-2">
									{cateAll.length} projects
								</Typography>
							</CardContent>
						</CardActionArea>
					</Card>
						...
						>
							...
							>
								...
								>
									...
									<Typography variant="body2" className="text-center txt-mte my-2">
										{item.project_detail_num} projects
									</Typography>
								</CardContent>
							</CardActionArea>
						</Card>
			...
			<Box>
				<Button
					className="h-16 px-8 py-5 bg-mte text-white text-xl font-bold my-4"
					fullWidth
					variant="text"
				>
					All Projects
						...
						<Box className="w-1/2 mb-10">
							<Box className="h-full" display="flex">
								<Box className="w-1/3 ms-6">
									<Button className="bg-mte text-white px-5" variant="text">
										{item.cate_title}
									</Button>
									<List>
									...
									<Typography variant="h6" className="ms-2 txt-mte flex items-center">
										{item.cate_pro_name}
									</Typography>
								</Box>
								<Box className="w-2/3">
									{item.detail.map((item: any, index: number) => (
										...
										>
											<ListItemIcon
												sx={{ minWidth: "30px", ml: item.endsWith(":") ? 0 : 2 }}
											>
												{item.endsWith(":") ? "" : <BsDot />}
											</ListItemIcon>
											<ListItemText
